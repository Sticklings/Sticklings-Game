...
public class Game {
	...
	/**
	 * Sets the games speed as a percent of real-time. 1 = realtime
	 * 
	...
	/**
	 * Gets the games speed as a percent of real-time. 1 = realtime
	 * 
	...
	/**
	 * Gets the active screen manager. Use this to transition between screens and control the game window
	 * 
