...
public class GameRenderer {
	...
	/**
	 * Sets the top left coord of the view, relative to the scene. The size of the view is the same as the screen size
	 * 
	...
	/**
	 * Gets the top left most coord of the view start relative to the scene. The size of the view is the same as the screen size
	 * 
