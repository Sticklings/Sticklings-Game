    ...
    public Parent initialize() {
        ...
        btn_help.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                String info
                        = "Welcome to Sticklings!\n"
                        + "The aim of the game is to get as many sticklings to the end of the level.\n"
                        + "\n"
                        + "There may be some obstacles in your way though...\n"
                        + "\n"
                        + "You can select different types of Sticklings by clicking on the bar on the bottom. "
                        + "There are only a certain number of characteristics so use them carefully!\n"
                        ...
                        + "\n"
                        + "Miner:\n"
                        + "Started looking for precious gems, now trying to escape, problem is it only knows how to dig "
                        + "on a steep decline. Will start mining through the ground and continue until it breaks through.\n "
                        + "\n"
                        + "Floater:\n"
                        + "Once a daredevil, always a daredevil. Equipped with a jetpack with enough thrust "
                        + "to fly to mars and back, this little guy can survive any fall distance, assuming you turn it on.\n"
                        + "\n"
                        + "Blocker:\n"
                        + "Good luck getting into this night club. Not even Kim Kardashian herself can get past this guy. "
                        + "Whether it be a large hole or you want to speed up things, no Stickling shall pass!\n"
                        + "\n"
                        + "Swimmer:\n"
                        + "This Stickling may run near the pool or dive into the shallow end but at least it is wearing "
                        + "it's floaties to keep it from drowning.\n"
                        + "\n"
                        + "Exploder:\n"
                        + "This Stickling is trying to find it's purpose in life and "
                        + "still can't figure out why all its friends run away when it shows up."
                        + " At least it can help take away a left over blocker\n"
                        + "\n"
                        + "The Sticklings were enjoying their lazy days running around in grass and sleeping on trees "
                        + "until a conga line party led them to fall down a hidden trap door that landed them in a cave of despair. \n"
                        + "Luckily enough, each Stickling has a hidden characteristic that can be activated. With a magic portal "
                        + "to lead them back, the Sticklings are desperate to get home and won't stop walking to get there";
