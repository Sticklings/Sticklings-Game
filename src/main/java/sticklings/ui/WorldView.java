...
public class WorldView extends Screen {
	...
	public Parent initialize() {
		...
		// ----------------------------------------------------------------------
		ToggleButton btn_miner = createTypeButton(SticklingType.Miner, 0, loadImage("/ui/btn_miner_selected.png"), loadImage("/ui/btn_miner_unselected.png"), loadImage("/ui/miner_cursor.png"));
		qty_miner = set_qty_label(SticklingType.Miner, btn_miner);
		lbl_miner = set_name_label("Miner", btn_miner, lbl_miner);
		// ----------------------------------------------------------------------
		ToggleButton btn_floater = createTypeButton(SticklingType.Floater, btn_miner.getLayoutX() + btn_stickling_width, loadImage("/ui/btn_floater_selected.png"), loadImage("/ui/btn_floater_unselected.png"), loadImage("/ui/floater_cursor.png"));
		qty_floater = set_qty_label(SticklingType.Floater, btn_floater);
		lbl_floater = set_name_label("Floater", btn_floater, lbl_floater);
		// ----------------------------------------------------------------------
		ToggleButton btn_blocker = createTypeButton(SticklingType.Blocker, btn_floater.getLayoutX() + btn_stickling_width, loadImage("/ui/btn_blocker_selected.png"), loadImage("/ui/btn_blocker_unselected.png"), loadImage("/ui/blocker_cursor.png"));
		qty_blocker = set_qty_label(SticklingType.Blocker, btn_blocker);
		lbl_blocker = set_name_label("Blocker", btn_blocker, lbl_blocker);
		// ----------------------------------------------------------------------
		ToggleButton btn_swimmer = createTypeButton(SticklingType.Swimmer, btn_blocker.getLayoutX() + btn_stickling_width, loadImage("/ui/btn_swimmer_selected.png"), loadImage("/ui/btn_swimmer_unselected.png"), loadImage("/ui/swimmer_cursor.png"));
		qty_swimmer = set_qty_label(SticklingType.Swimmer, btn_swimmer);
		lbl_swimmer = set_name_label("Swimmer", btn_swimmer, lbl_swimmer);
		// ----------------------------------------------------------------------
		ToggleButton btn_exploder = createTypeButton(SticklingType.Exploder, btn_swimmer.getLayoutX() + btn_stickling_width, loadImage("/ui/btn_exploder_selected.png"), loadImage("/ui/btn_exploder_unselected.png"), loadImage("/ui/exploder_cursor.png"));
